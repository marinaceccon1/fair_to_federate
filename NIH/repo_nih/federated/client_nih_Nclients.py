...
=======================
Flower client entry point for the N-client federated learning setup.

Usage (launched automatically by run_experiments_cumulative_Nclients.py):

    GRPC_PORT=8080 CONFIG_PATH=experiments/current_config_worker0.json \
    NIH_DATA_PATH=/path/to/images \
        python client_nih_Nclients.py --cid 3
"""
...
# ---------------------------------------------------------------------------
# Repo root: three levels up from this file (NIH/repo/federated/client_nih_Nclients.py)
# ---------------------------------------------------------------------------
